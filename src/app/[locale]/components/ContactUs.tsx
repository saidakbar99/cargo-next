...
export const ContactUs = () => {
  ...
  return (
    <div id="contactUs" className="mt-[18px] lg:mt-[108px]">
      <h2 className="font-roadRadio font-bold text-[32px] lg:text-[50px] text-center mb-9 lg:mb-12">{t('contactUs')}</h2>
      <MyMap /> 
        ...
        <div className="p-6 lg:p-12 bg-black lg:min-w-[464px] order-2 lg:order-none rounded-xl lg:rounded-e-none">
          <div className="py-4 flex">
            ...
            <div className="flex flex-col ml-5">
              <span className="mb-2 text-white text-xl font-semibold">{t('contactUstitle')}</span>
              <span className="text-lightGray font-medium">{t('contactUstext')}</span>
          ...
          <div className="py-4 flex my-8">
            ...
            <div className="flex flex-col ml-5">
              <span className="mb-2 text-white text-xl font-semibold">{t('contactUstitle2')}</span>
              <span className="text-lightGray font-medium">{t("contactUstext2")}</span>
          ...
          <div className="py-4 flex">
            ...
            <div className="flex flex-col ml-5">
              <span className="mb-2 text-white text-xl font-semibold">{t('contactUstitle3')}</span>
              <span className="text-lightGray font-medium">{t('contactUstext3')}</span>
        ...
        <div className="p-6 lg:p-24 w-full order-1 lg:order-none border border-lightGray rounded-xl lg:rounded-s-none mb-9 lg:mb-0">
          <div className="flex flex-col mb-6">
            ...
            <input
              ...
              placeholder={t('contactUsinpplace')}
            />
          </div>
          <div className="flex flex-col mb-6">
          ...
          <div className="flex mb-8">
            ...
            <span className="text-gray ml-3">{t('contactUscheck')}</span>
          </div>
          <Button className="w-full" variant="orange" text={t('contactUsbutton')} />
        </div>
      </div>
    </div>
  )
