...
export const Process = () => {
  ...
  return ( 
    <div id='process' className='text-center mt-[50px] lg:mt-[140px]'>
      ...
      <div className='lg:flex mt-9 lg:mt-12 justify-between'>
        <div className='flex flex-col flex-1 items-center px-4 py-[22px]'>
        ...
        <div className='flex flex-col flex-1 items-center px-4 py-[22px] mt-6 lg:mt-0'>
