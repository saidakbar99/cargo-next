...
export const PersonalSettings = () => {
	...
	const genderDisplay =
		profileData.gender === 1 ? t("gender.male") : t("gender.female");
	...
	return (
		<div className="grid grid-cols-12 gap-x-3 gap-y-6 mt-9 max-[500px]:grid-cols-1">
			<div className="col-span-9 max-[500px]:col-span-1 max-[500px]:col-span-6">
			...
			<div className="col-span-3 max-[500px]:col-span-6">
			...
			<div className="col-span-6 max-[500px]:col-span-6">
